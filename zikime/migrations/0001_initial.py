...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Serial',
            fields=[
                ('serial_number', models.CharField(db_column='SerialID', help_text='This serial number must be unique.', max_length=50, primary_key=True, serialize=False, verbose_name='시리얼 번호')),
                ('created_at', models.DateTimeField(db_column='CRE_DT', help_text='This value is entered automatically.', null=True, verbose_name='생성 날짜')),
                ('deleted_at', models.DateTimeField(blank=True, db_column='DEL_DT', help_text='If you enter the date here, this device will no longer be available.', null=True, verbose_name='만료 날짜')),
            ],
            options={
                'verbose_name': '시리얼 정보',
