...
class Device(models.Model):
    ...
    owner = models.ForeignKey(CustomUser, db_column='User_ID', verbose_name='기기 소유주', help_text='This value is automatically entered by device connecting.', on_delete=models.SET_DEFAULT, default='-1', ) # to be determined
    created_at = models.DateTimeField(db_column='CRE_DT', verbose_name='기기 등록 날짜', help_text='This value is automatically entered when the table is created.',auto_now_add=True,  null=True)
...
class Status(models.Model):
    device = models.OneToOneField(Device, db_column='Device_ID',verbose_name='디바이스 시리얼 번호', help_text='This value is automatically entered when the table is created.',on_delete=models.CASCADE)
...
class Regist(models.Model):
    ...
    device = models.OneToOneField(Device, db_column='Device_ID', verbose_name='디바이스 ID', help_text='TThis value is automatically entered when the table is created. owner\'s device id ', on_delete=models.CASCADE)
...
class Permission(models.Model):
    user = models.ForeignKey(Device,db_column='User_ID', verbose_name='기기에 연결된 사용자', help_text='This value must be entered by the owner or by the user specified by the owner.', on_delete=models.CASCADE, related_name='permission_user_id')
    ...
    created_at = models.DateTimeField(db_column='CRE_DT', verbose_name='생성날짜', help_text='This value is automatically entered when the table is created.', auto_now_add=True, null=True)
    changed_at = models.DateTimeField(db_column='CHG_DT', verbose_name='수정날짜', help_text='This value is automatically entered when the table is updated.', auto_now=True)
...
class History(Status):
    user= models.ForeignKey(CustomUser, db_column='UID', verbose_name='소유자', help_text='This value is automatically entered when the table is created.', on_delete=models.CASCADE)
    created_at = models.DateTimeField(db_column='CRE_DT', verbose_name='생성 날짜', help_text='This value is automatically entered when the table is created.', auto_now_add=True, null=True)
